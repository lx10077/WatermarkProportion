...
def refined_estimator_optimal_weight(observed_Y, cdf, use_iterative, n_sample, n_legnth, N0=500):
    """
    ...
    uniform_data = np.random.uniform(0, 1, n_sample * n_legnth).reshape(-1)
